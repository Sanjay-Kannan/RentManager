...
namespace WebApi.Controllers
{
    ...
    public class RentsController : ControllerBase
    {
        ...
        public RentsController(RentManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Rent>> PostRent(Rent rent)
        {
          if (_context.Rents == null)
          {
            ...
            return CreatedAtAction("GetRent", new { id = rent.PaymentId }, rent);
        }
        ...
        {
            return (_context.Rents?.Any(e => e.PaymentId == id)).GetValueOrDefault();
        }
    }
}
