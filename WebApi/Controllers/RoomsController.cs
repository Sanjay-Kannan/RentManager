...
namespace WebApi.Controllers
{
    ...
    public class RoomsController : ControllerBase
    {
        ...
        public RoomsController(RentManagerContext context)
        {
            _context = context;
        }
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutRooms(int id, Room room)
        {
            if (id != room.RoomId)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Room>> PostRooms(Room rooms)
        {
          if (_context.Rooms == null)
          {
